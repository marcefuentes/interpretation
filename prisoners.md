...
This document summarizes insights from analyzing the heatmaps generated by graphgen --study prisoners --figure s07.

Role in this project: **prisoners is a calibration study**, not a primary endpoint. Its value is to clarify mechanism behavior (partner-choice bottlenecks, bistability, hitchhiking, exploitation signatures) that helps interpret **mutualism** as the main biological target and **Hamilton** as the equal-parameter special case of mutualism.

It covers pop_3 (panels e-f, evolving population), pop_2 (panels a-d, two coevolving populations), pop_1 (panel i, single population), the emergent asymmetry and sharp phase transition in cooperation near the R ≈ P diagonal, C1P0 free-riders at high R−P, and cross-study comparisons with the Hamilton game.
