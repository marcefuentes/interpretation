...
split that is absent in the left control columns of Fig. 2. In snowdrift, a similar
...
parameter symmetry, read the control versus partner-choice columns in Fig. 2; deterministic under cooperation-cost
