...
([symmetric_c_i.md](../journal/symmetric_c_i.md)). Taxing the machinery alone (c = 0)
...
- **Symmetric payoffs split stochastically.** In symmetric_c pop_2 (and the symmetric
...
- **Information cost compresses the split by collapsing both sides.** On the
  ...
  ([asymmetric_c1_i.md](../journal/asymmetric_c1_i.md)).
...
some of the strongest results sit ([symmetric_c_i.md](../journal/symmetric_c_i.md),
[synthesis.md](../journal/synthesis.md)).
...
- **The decoupling has a boundary.** On the asymmetric branch with c0 fixed at 0.10,
  ...
  high-cooperation niche behind ([asymmetric_c1_i.md](../journal/asymmetric_c1_i.md)).
