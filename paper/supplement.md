...
| ---- | ---- | ---------------- |
| Fig. S1 | No-enforcement control under cooperation-cost asymmetry | Fig. 3 |
| Fig. S2 | Short-memory / shuffle reciprocity branches | Fig. 1 |
...
Captions for Figs. S1–S9 are in [captions.md](captions.md) (regenerated from the
...
**Fig. 1 hierarchy.** Shuffle short-memory variants that can shift the
direct-reciprocity collapse ordering: Fig. S2.

**Figs. 2–3 role split.** No-enforcement asymmetric control: Fig. S1. Deterministic
versus stochastic strips on shared axes: Fig. S5. Full c₀ × c₁ coverage: Fig. S9.
Small-group robustness (gs = 4): Fig. S3.

**Fig. 4 decoupling.** Full Cost × c surface: Fig. S7. Dilemma-0 control (machinery
