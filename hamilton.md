...
**Scope note (light merge with mutualism).** Hamilton is the diagonal special case of mutualism (*b*0 = *b*1, same *c*). To avoid repeating shared model mechanics, use **mutualism.md** for the general cross-study framing (payoff structure, bottleneck logic, diagonal relation); this file focuses on Hamilton-specific patterns and numbers.
...
For the full Hamilton-branch derivation and cross-population generalization, see **mutualism.md** (**Given = 0.5: Correct Game-Type Classification**). On the Hamilton diagonal (*b*0 = *b*1), the regime split is:
