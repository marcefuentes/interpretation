...
Without stable pairings, TFT cannot accumulate history. Mean qBSeen (pop_1, gs=128) for M drops from 0.599 (noshuffle) to 0.497 (shuffle) — indistinguishable from the control (0.493 under control). This matches the shuffle penalty seen in symmetric_c and asymmetric_c0_c1.
