...
| -------- | ----- | ---------- | --------------- |
| K (baseline fitness) | 0.5 | hamilton, mutualism, hamilton_cost | .glo `K` |
| b (benefit) | 0.4, fixed | hamilton, mutualism, hamilton_cost | .glo `b` |
| c (cooperation cost) | swept 0 to b | hamilton (c0 = c1), mutualism (c0 < c1) | .glo `c0`, `c1` |
| Cost (information cost) | 0.001 default; swept 0 to 0.4 in hamilton_cost | all studies | .glo `Cost` |
...
w = max(0, payoff − cost). See journal/hamilton_cost.md for the swept-Cost study.

## Hamilton / mutualism payoffs

These two studies are parameterized by K, b, and cost. Hamilton is the equal-cost
...
always has the stronger cooperation incentive). Full tables in journal/hamilton.md
