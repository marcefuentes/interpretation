...
For the symmetric Cost x c sweep, see [symmetric_c_i.md](symmetric_c_i.md).

## Design and sanity

- Study pair: asymmetric_c1_i (Runs = 30 image summaries) and asymmetric_c1_i_1run
...
symmetric_c_i's striking result was that cooperation could remain high after the
active enforcement alleles had largely vanished. asymmetric_c1_i shows the boundary
...
So the snowdrift lesson from symmetric_c_i still holds only half-way. High S makes
