...
Comparing direct reciprocity (M) and indirect reciprocity (IM, IJM) to the control (_) in the coevolving setup (pop_2) reveals that reciprocity has a strong tendency to enforce symmetry and prevent role splits:

- **Prisoner's Dilemma (PD):** 
  - **Direct Reciprocity (M under noshuffle):** The major effect is **increasing cooperation symmetrically** in both populations (fset_0 +0.689, fset_1 +0.690 on average across cells). Net asymmetry remains virtually zero (average 0.009). Because conditional reciprocity (TFT) ties cooperation to the partner's actions, a cooperator cannot play unless its partner cooperates too. This prevents one population from exploiting the other and suppresses the stochastic symmetry breaking seen under partner choice.
  - **Indirect Reciprocity under shuffle (IM and IJM):** Where direct reciprocity is destroyed by shuffling, reputation-based reciprocity is highly effective. **IM** (recent indirect reciprocity) has a major effect of **increasing cooperation symmetrically** (fset_0 +0.388, fset_1 +0.357, asymmetry remains low at 0.042). **IJM** (recent + lifetime indirect reciprocity) increases cooperation even further (fset_0 +0.431, fset_1 +0.435) while reducing asymmetry to almost zero (0.007). The lifetime reputation signal J is noise-resistant, allowing cooperators to coordinate without any role splits.
- **Snowdrift:** 
  - **Direct Reciprocity (M under noshuffle):** The major effect is **decreasing asymmetry** (by -0.217 on average). Under control, the Snowdrift payoff floor already sustains high cooperation in fset_0 (0.89) but low cooperation in fset_1 (0.20), leading to high asymmetry (0.69). M enforces symmetry by bootstrapping cooperation in fset_1 to 0.40 (+0.208 boost), narrowing asymmetry to 0.475 on average. At moderate costs (e.g. c = 0.08), asymmetry drops from 0.725 (control) to 0.015 (M) as both populations converge on symmetric cooperation.
  - **Indirect Reciprocity under shuffle (IM and IJM):** Reputation-based reciprocity has the major effect of **decreasing asymmetry** (by -0.209 for IM, and a massive -0.550 for IJM). **IJM** bootstraps fset_1's cooperation to 0.788 (+0.592 change) by using lifetime reputation J to identify and withhold cooperation from defectors, forcing them to cooperate and collapsing the asymmetry to 0.141.
