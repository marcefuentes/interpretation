...
UNAMBIGUOUS: list[tuple[str, str]] = [
    ("mutualism_infocost_1run", "asymmetric_i0_i1_1run"),
    ("mutualism_infocost", "asymmetric_i0_i1"),
    ("mutualism_cost_1run", "asymmetric_c1_i_1run"),
    ("mutualism_cost", "asymmetric_c1_i"),
    ("mutualism_1run", "asymmetric_c0_c1_1run"),
    ("diagonal_infocost_1run", "symmetric_i_1run"),
    ("diagonal_infocost", "symmetric_i"),
    ("symmetric_i_1run", "symmetric_c_i_1run"),
    ("symmetric_i", "symmetric_c_i"),
...
def rename_test_files(tests_dir: Path) -> None:
    if not tests_dir.is_dir():
        return
    pairs = [
        ("test_studies_symmetric_i_1run.py", "test_studies_symmetric_c_i_1run.py"),
        ("test_studies_symmetric_i.py", "test_studies_symmetric_c_i.py"),
        ("test_studies_diagonal_infocost.py", "test_studies_symmetric_i.py"),
        ("test_studies_diagonal.py", "test_studies_symmetric_c.py"),
        ("test_studies_mutualism_cost_1run.py", "test_studies_asymmetric_c1_i_1run.py"),
        ("test_studies_mutualism_cost.py", "test_studies_asymmetric_c1_i.py"),
    ]
...
def rename_journal_files(journal_dir: Path) -> None:
    pairs = [
        ("symmetric_i.md", "symmetric_c_i.md"),
        ("mutualism_cost.md", "asymmetric_c1_i.md"),
...
def rename_ai_scripts(ai_dir: Path) -> None:
    pairs = [
        ("analyze_symmetric_i.py", "analyze_symmetric_c_i.py"),
        ("analyze_mutualism_cost.py", "analyze_asymmetric_c1_i.py"),
    ]
    for old, new in pairs:
