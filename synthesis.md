...
- **PD only.** Prisoners covers dilemma 1 with symmetric pop_2 payoffs; the
  snowdrift attributions above are inferred from the geometry (high S → low
  risk) and corroborated by hamilton/mutualism snowdrift data, not measured on
  a prisoners snowdrift sweep (none exists; see **snowdrift.md**).
