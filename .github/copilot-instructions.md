...
**asymmetric_c1_i0_i1**: Study B — fixed cooperation-cost gap c0=0.10, c1=0.20; full Cost0×Cost1 square (176 cells; Cost0≤0.30, Cost1≤0.20). pop_2; same ecology as other TRPS studies. graphgen: `asymmetric_c1_i0_i1` / `_1run`. Cesga: `~/code/cesga/python/studies/asymmetric_c1_i0_i1/`.
